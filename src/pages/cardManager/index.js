    ...
    const cardProps = {
      ...
      colorPicker: {
        ...
        value: backgroundImage
          ? `${window.URL_SERVER}/api/v2${backgroundImage}`
          : backgroundColor,
      },
    ...
    <center>
      <div className="max-w-[640px]">
        ...
        {!listCard?.length && (
          <div>
            ...
            <center className="text-[15px] text-white ">
              <div className="leading-[22px]">Bạn chưa có mẫu thẻ nào.</div>
              <div className="leading-[22px]">Cá nhân hoá ngay thôi!</div>
              <IconEmpty className="m-[10px]" />
            </center>
            <BaseButton
              content="Thêm thẻ"
              preFix={<IconAddCard />}
              className="w-full mt-[2px] text-[12px] btnCard"
              handleClick={() => {
                setCardInfo(null)
                setIsModalCard(true)
              }}
        ...
        <DeleteCardPU
          ...
          onSubmit={onSaveDelete}
        />
        <Modal
          className="modal-full"
          open={isModalCard}
          onCancel={() => setIsModalCard(false)}
          footer={[]}
        >
